<x-layout>
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <aside class="bg-white rounded-lg shadow-md p-3">
            ...
            <a
                href=""
                class="mt-10 bg-blue-500 hover:bg-blue-600 text-white font-bold w-full py-2 px-4 rounded-full flex items-center justify-center"><i class="fas fa-bookmark mr-3"></i> Bookmark Listing</a>
        </aside>
    </div>
</x-layout>
